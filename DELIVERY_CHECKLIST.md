...
- **File**: [src/editor/plugins/ToolbarPlugin/Tools/AITools.tsx](src/editor/plugins/ToolbarPlugin/Tools/AITools.tsx)
...
The Azure provider uses a custom fetch wrapper to transform standard OpenAI URLs into Azure's deployment-based format:
...
This allows the official `@ai-sdk/azure` package to work with Azure's gateway proxy architecture.
...
- The implementation follows the architecture guidelines in [.github/instructions/ai.instructions.md](.github/instructions/ai.instructions.md)
