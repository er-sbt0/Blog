...
import { getPostCreatedAt } from "@/utils/posts/postHelpers";

/** Single source of truth for time-filter value → human label mappings. */
export const FILTER_LABELS: Record<TimeFilterValue, string> = {
  all: "All Time",
  thisYear: "This Year",
