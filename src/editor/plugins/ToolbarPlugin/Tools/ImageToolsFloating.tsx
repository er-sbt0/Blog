...
export default function ImageToolsFloating(
  { editor, node, sx }: {
  ...
  const nodeId = node.__key || Math.random().toString(36).substring(2, 9);

  return (
    <ToolsContainer id={`image-tools-${nodeId}`} priority={18}>
