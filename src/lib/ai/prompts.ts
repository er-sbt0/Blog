...
export const SYSTEM_PROMPTS: Record<AIOptionType, string> = {
  improve: BASE_SYSTEM_PROMPT + " You are asked to rewrite what user writes in another way.",
  continue: BASE_SYSTEM_PROMPT + " You are asked to continue writing more text following user's input.",
  shorter: BASE_SYSTEM_PROMPT + " You are asked to rewrite what user writes in a shorter form.",
  longer: BASE_SYSTEM_PROMPT + " You are asked to rewrite what user writes in a longer form.",
  zap: BASE_SYSTEM_PROMPT + " You are asked to help the user with his document.",
} as const;
